...
Unless those people [petition](/he/reference/glossary#petition), or pay the government for permission (where the word "permit" is derived from) to be allowed to exercise those behaviors. This amounts to the claim that rights are merely privileges that may be granted or taken away by government at any time, based upon the people in government's preference or discretion.

Remembering that the definition of a [right](/he/reference/glossary#right) is: "any action which does not cause harm to another sentient being or their property". It can be readily seen that there is no such thing as the "right" to stop someone from exercising a right, since rights cause no harm.
