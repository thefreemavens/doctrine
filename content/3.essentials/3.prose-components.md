...
---
  :::accordion
    ...
    label: What are the main considerations when upgrading to The Freemavens v3?
    ---
    ...
    ---
    icon: i-lucide-circle-help
    label: Is The Freemavens v3 compatible with standalone Vue projects?
    ---
    The Freemavens is now compatible with Vue! You can follow the [installation guide](/getting-started/installation) to get started.
    ::::
  :::
...
:::accordion-item{label="What are the main considerations when upgrading to The Freemavens v3?" icon="i-lucide-circle-help"}
The transition to v3 involves significant changes, including new component structures, updated theming approaches, and revised TypeScript definitions. We recommend a careful, incremental upgrade process, starting with thorough testing in a development environment.
:::

:::accordion-item{label="Is The Freemavens v3 compatible with standalone Vue projects?" icon="i-lucide-circle-help"}
The Freemavens is now compatible with Vue! You can follow the [installation guide](/getting-started/installation) to get started.
:::
...
---
  :::steps{level="4"}
  #### Add the The Freemavens module in your `nuxt.config.ts`
  ...
  #### Import Tailwind CSS and The Freemavens in your CSS
...
#### Add the The Freemavens module in your `nuxt.config.ts`{lang="ts-type"}
